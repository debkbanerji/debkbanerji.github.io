...
var stylesheetBootstrap = loadCSS( "https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css");
onloadCSS( stylesheetBootstrap, function() {
    console.log( "Stylesheet bootstrap has loaded." );
});

var stylesheetStyle = loadCSS("./CSS/style.css");
onloadCSS( stylesheetStyle, function() {
    console.log("Stylesheet style has loaded.");
});